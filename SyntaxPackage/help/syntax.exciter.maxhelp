...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 80.5, 209.0, 58.0, 22.0 ],
									"text" : "autofit $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 80.5, 180.5, 70.0, 22.0 ],
									"text" : "loadmess 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.5, 127.0, 95.0, 21.0 ],
									"text" : "sprintf %s.jpeg"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.5, 153.0, 71.0, 22.0 ],
									"text" : "prepend pic"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 59.5, 291.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 395.0, 34.0, 71.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 395.0, 64.0, 323.0, 263.0 ],
					"pic" : "piano1.jpeg",
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 36.0, 514.0, 452.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 313.0, 105.0, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 321.0, 134.0, 42.0, 16.0 ],
					"preset_data" : [ 						{
							"number" : 1,
							"data" : [ 5, "obj-29", "flonum", "float", 0.0, 5, "obj-28", "flonum", "float", 10.0, 5, "obj-27", "flonum", "float", 5.0, 5, "obj-26", "flonum", "float", 1.0, 5, "obj-25", "flonum", "float", 4.0, 5, "obj-24", "flonum", "float", -12.0, 5, "obj-23", "flonum", "float", 0.0 ]
						}
, 						{
							"number" : 2,
							"data" : [ 5, "obj-29", "flonum", "float", 0.0, 5, "obj-28", "flonum", "float", 20.0, 5, "obj-27", "flonum", "float", 10.0, 5, "obj-26", "flonum", "float", 1.0, 5, "obj-25", "flonum", "float", 10.0, 5, "obj-24", "flonum", "float", -18.0, 5, "obj-23", "flonum", "float", 0.0 ]
						}
, 						{
							"number" : 3,
							"data" : [ 5, "obj-29", "flonum", "float", 12.0, 5, "obj-28", "flonum", "float", 20.0, 5, "obj-27", "flonum", "float", 5.0, 5, "obj-26", "flonum", "float", 0.699999988079071, 5, "obj-25", "flonum", "float", 12.0, 5, "obj-24", "flonum", "float", -36.0, 5, "obj-23", "flonum", "float", 0.0 ]
						}
 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 49.0, 101.0, 44.0, 22.0 ],
					"text" : "noise~"
				}
...
,
					"patching_rect" : [ 376.400012016296387, 371.599999666213989, 58.0, 23.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 13.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 215.0, 371.599999666213989, 127.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-59",
					"margins" : [ 12.0, 12.0, 40.0, 50.0 ],
					"maxclass" : "plot~",
					"numinlets" : 1,
					"numoutlets" : 1,
					"numpoints" : 512,
					"outlettype" : [ "" ],
					"patching_rect" : [ 215.0, 399.0, 503.0, 299.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 49.0, 500.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 317.0, 305.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 317.0, 280.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 317.0, 179.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 317.0, 155.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 202.0, 305.0, 113.0, 22.0 ],
					"text" : "pak makeup.gain f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 202.0, 280.0, 113.0, 22.0 ],
					"text" : "pak release f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 202.0, 255.0, 113.0, 22.0 ],
					"text" : "pak attack f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 202.0, 229.0, 113.0, 22.0 ],
					"text" : "pak knee f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 202.0, 204.0, 113.0, 22.0 ],
					"text" : "pak ratio f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 202.0, 179.0, 113.0, 22.0 ],
					"text" : "pak threshold f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 202.0, 155.0, 113.0, 22.0 ],
					"text" : "pak in.gain f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 49.0, 347.599999666213989, 172.0, 22.0 ],
					"text" : "syntax.compressor"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "syntax.filter violin_front"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 49.0, 441.0, 136.0, 47.0 ],
...
, 			{
				"box" : 				{
					"id" : "obj-8",
					"items" : [ "filter", "violin_front", ",", "filter", "violin_back", ",", "filter", "alto_front", ",", "filter", "alto_back", ",", "filter", "cello_front", ",", "filter", "cello_back", ",", "filter", "piano1", ",", "filter", "piano2", ",", "filter", "pianoSUB", ",", "filter", "perc_TamTam", ",", "filter", "perc_Cassa" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 95.0, 101.0, 151.0, 22.0 ],
					"pattrmode" : 1
				}
...
, 			{
				"name" : "piano1.jpeg",
				"bootpath" : "~/Documents/SyntaxResearch/SyntaxMaxPackage/SyntaxPackage/pics",
